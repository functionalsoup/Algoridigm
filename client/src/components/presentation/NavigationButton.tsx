...
export function NavigationButton({ onClick, children, variant, disabled = false }: NavigationButtonProps) {
  const getStyles = () => {
    switch (variant) {
      ...
      case "begin":
        return "bg-gradient-to-r from-corp-cyan via-corp-blue to-corp-magenta text-white font-bold px-12 py-5 text-2xl uppercase tracking-[0.25em] text-shadow-glow";
      case "about":
